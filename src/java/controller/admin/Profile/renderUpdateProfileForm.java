 ...
 * @author LENOVO
 */
public class renderUpdateProfileForm extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse res)
        ...
        req.setAttribute("infor", inforUser);
        //end

        req.getRequestDispatcher("/views/admin/pages/profile/updateProfile.jsp").forward(req, res);
    }
