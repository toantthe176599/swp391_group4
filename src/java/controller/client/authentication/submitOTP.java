...
public class submitOTP extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet submitOTP</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet submitOTP at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse res)
        ...
        if (checkOtpStatus.isIsSuccess() == false) {
            session.setAttribute("error", checkOtpStatus.getDescription());
            res.sendRedirect("/views/client/pages/OTPForm.jsp");
            return;
        }
        String token = (String) checkOtpStatus.getObject();
