...
public class queryEventClient {
    ...
    public List<Event_client> getAllEvent() {
        ...
        String query = "select event_id, name, title, start_time, start_date, location, image_event from event";
    ...
    String query = "SELECT event_id, name, title, start_time, start_date, location, image_event " +
                   "FROM event WHERE LOWER(name) LIKE ?";
...
private void closeResources() {
    ...
    String query = "SELECT event_id, name, title, start_time, start_date, location, image_event " +
                   "FROM event " +
                   "WHERE MONTH(start_date) = ? AND category = ?";
    ...
    List<Event_client> list = new ArrayList<>();
    String query = "SELECT event_id, name, title, start_time, start_date, location, image_event " +
                   "FROM event WHERE MONTH(start_date) = ?";
