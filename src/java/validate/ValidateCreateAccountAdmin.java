...
public class ValidateCreateAccountAdmin implements Filter {
    ...
    private void doBeforeProcessing(ServletRequest request, ServletResponse response)
        ...
        if (debug) {
            log("validateUserInAdmin:DoBeforeProcessing");
        }
    ...
    private void doAfterProcessing(ServletRequest request, ServletResponse response)
            throws IOException, ServletException {
        if (debug) {
            log("validateUserInAdmin:DoAfterProcessing");
        }
    ...
    public String toString() {
        if (filterConfig == null) {
            return ("validateUserInAdmin()");
        }
        StringBuffer sb = new StringBuffer("validateUserInAdmin(");
