 ...
 * @author LENOVO
 */
public class validateUpdateAccountAdmin implements Filter {
    ...
    public validateUpdateAccountAdmin() {
    }

    private void doBeforeProcessing(ServletRequest request, ServletResponse response)
            throws IOException, ServletException {
        if (debug) {
            log("validateUpdateAccountAdmin:DoBeforeProcessing");
        }
    ...
    private void doAfterProcessing(ServletRequest request, ServletResponse response)
            throws IOException, ServletException {
        if (debug) {
            log("validateUpdateAccountAdmin:DoAfterProcessing");
        }
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        if (debug) {
            log("validateUpdateAccountAdmin:doFilter()");
        }
    ...
    public void init(FilterConfig filterConfig) {
        ...
        if (filterConfig != null) {
            if (debug) {
                log("validateUpdateAccountAdmin:Initializing filter");
            }
        }
    }
    ...
    public String toString() {
        if (filterConfig == null) {
            return ("validateUpdateAccountAdmin()");
        }
        StringBuffer sb = new StringBuffer("validateUpdateAccountAdmin(");
