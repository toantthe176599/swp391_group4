...
<html>
    ...
    <body>
                                ...
                                <main style="margin-left: 100px; width: 1800px">
                                    <div class="form-container">
                                        ...
                                        <form action="/admin/blog/edit" method="post" formCreate autocomplete="on" enctype="multipart/form-data">
                                            ...
                                            <div class="row">
                                                <input type="text" placeholder="Nhập tiều đề cho bài viết" name="title" value="${blog.title}" id="eventname" required="true" title="Vui lòng nhập tên sự kiện">
                                            </div>

                                            <!--desctiption-->
                                            <label for="content"  style="margin-top: 30px;" ><b><h4>Nội dung sự kiện</h4></b></label>
                                            <div class="row">
                                                <textarea  name="content" rows="5" class="default" id="content" cols="10" placeholder="Nội dung bài viết">
                                            ...
                                            <div class="row">
                                                <input type="text" placeholder="Nhập tên tác giả" name="author" value="${blog.author}" id="author" required="true">
                                            </div>
                                            ...
                                            <div class="row">
                                                <input type="date" placeholder="dd/mm/yyyy" name="start_date"  value="${blog.startDate}" id="start_date" required="true">
                                            </div>
                                            ...
                                            <div>
                                                <input type="file" name="image_blog" image_blog value="" accept="image/*">
                                                <input type="hidden" name="image_blog_change" value="false">
                                            </div>
                                            <div  style="display: block" > <img preview-img class="image-preview" src="${blog.image}"alt="alt"/>
                                            ...
                                            <div class="main" style="margin-top: 20px">
                                                <div class="card">
                                                    ...
                                                    <div class="form">  
                                                        <label><input type="radio" class="input-radio on" ${blog.status == 'active' ? 'checked' : ''} name="status" value="active"> ON</label>
                                                        <label><input type="radio" class="input-radio off" ${blog.status == 'inactive' ? 'checked' : ''} name="status" value="inactive"> OFF</label>
                                            ...
                                            <button type="button" submitBtn class="btn btn-primary" style="margin-top: 10px">Chỉnh sửa</button>
                                            <button type="button" cancelBtn idBlog="${blog.id}" class="btn btn-danger" style="margin-top: 10px">Hủy</button>
                                        </form>
                                    </div>
        ...
        <script src="../../../../public/admin/js/ImagePreviewForEditBlog.js"></script>
