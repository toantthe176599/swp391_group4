<%-- 
    Document   : Create
    Created on : Jun 19, 2024, 11:17:56 PM
    Author     : LENOVO
--%>
...
<html>
    <head>
        ...
        <title>Tạo mới loại sự kiện</title>
                            ...
                            <div class="mb-npx">
                                <div class="row align-items-center">
                                    <div class="col-sm-6 col-12 mb-4 mb-sm-0">
                                        <!-- Title -->
                                        <h1 class="h2 mb-0 ls-tight">Tạo 1  loại sự kiện mới </h1>
                                    </div>
                                    <!-- Actions -->
                                ...
                                <div class="table-responsive">
                                    <form action="/admin/category/create" method="POST">
                                        <div class="input-group flex-nowrap">
                                            <span class="input-group-text" id="addon-wrapping" > <b>Tên loại sự kiện</b></span>
                                            <input type="text" class="form-control" required name="categoryDescription" aria-describedby="addon-wrapping">
