...
<html>
    <head>
        ...
        <title>Chỉnh sửa thông tin nhóm quyền</title>
    </head>
    <body>
        ...
        <c:if test="${fn:contains(permissionRole, 'edit_role')}">
                                            ...
                                            <table class="table" table-permission>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td colspan="2" style="text-align: center"><h5> Sự kiện</h5></td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td colspan="2" style="text-align: center"><h5> Loại sự kiện</h5></td>

                                                    </tr>

                                                    <tr data-name="view_category" view_category>
                                                        <td><input type="checkbox" name="item[]" ></td>
                                                        <td>Xem các loại sự kiện</td>

                                                    </tr>

                                                    <tr data-name="add_category" add_category>
                                                        <td><input type="checkbox" name="item[]" ></td>
                                                        <td>Thêm loại sự kiện</td>

                                                    </tr>

                                                    <tr data-name="edit_category" edit_category>
                                                        <td><input type="checkbox" name="item[]" ></td>
                                                        <td>Sửa loại sự kiện</td>

                                                    </tr>

                                                    <tr data-name="delete_category" delete_category>
                                                        <td><input type="checkbox" name="item[]" ></td>
                                                        <td>Xóa loại sự kiện</td>

                                                    </tr>

                                                    <tr>

                                                        <td colspan="2" style="text-align: center"><h5> Bài viết</h5></td>

                                                    </tr>

                                                    <tr data-name="view_blog" view_blog>
                                                        <td><input type="checkbox" name="item[]" ></td>
                                                        <td>Xem bài viết</td>

                                                    </tr>

                                                    <tr data-name="add_blog" add_blog>
                                                        <td><input type="checkbox" name="item[]" ></td>
                                                        <td>Thêm bài viết</td>

                                                    </tr>

                                                    <tr data-name="edit_blog" edit_blog>
                                                        <td><input type="checkbox" name="item[]" ></td>
                                                        <td>Sửa bài viết</td>

                                                    </tr>

                                                    <tr data-name="delete_blog" delete_blog>
                                                        <td><input type="checkbox" name="item[]" ></td>
                                                        <td>Xóa bài viết</td>
                                                    ...
                                                    <tr>
                                                        <td colspan="2" style="text-align: center"><h5> Xem thông tin website </h5></td>
                                                    </tr>
                                                    <tr data-name="view_inforwebsite" delete_blog>
                                                        <td><input type="checkbox" name="item[]" ></td>
                                                        <td>Xem thông tin website</td>

                                                    </tr>
                                                    <tr data-name="edit_inforwebsite" delete_blog>
                                                        <td><input type="checkbox" name="item[]" ></td>
                                                        <td>Sửa thông tin website</td>
                                                    </tr>
